          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-white">
              <tr>
                ...
                <th className="px-6 py-5 text-left text-xs font-black text-gray-400 uppercase tracking-widest">Fee Head Breakdown</th>
              ...
              <AnimatePresence>
                {paginatedData.map((item) => (
                  ...
                  >
                    ...
                    {/* Fee Head Breakdown (Dynamic Tags) */}
                    <td className="px-6 py-5">
                      <div className="flex flex-wrap gap-2 max-w-[350px]">
                        {item.fees.tuition > 0 && <span className="px-2 py-1 bg-white border border-gray-200 text-gray-600 text-[11px] font-bold rounded">Tuition: ₹{item.fees.tuition.toLocaleString()}</span>}
                        {item.fees.practical > 0 && <span className="px-2 py-1 bg-white border border-gray-200 text-gray-600 text-[11px] font-bold rounded">Prac: ₹{item.fees.practical.toLocaleString()}</span>}
                        {item.fees.pd_af > 0 && <span className="px-2 py-1 bg-white border border-gray-200 text-gray-600 text-[11px] font-bold rounded">PD/AF: ₹{item.fees.pd_af.toLocaleString()}</span>}
                        {item.fees.other > 0 && <span className="px-2 py-1 bg-white border border-gray-200 text-gray-600 text-[11px] font-bold rounded">Other: ₹{item.fees.other.toLocaleString()}</span>}
                      </div>
                    </td>
