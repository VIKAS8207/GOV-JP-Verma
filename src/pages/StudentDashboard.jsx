...
export default function StudentDashboard() {
  ...
  // If a user navigates here directly, it defaults to Year "1" and "B.Tech"
  const studentYear = location.state?.registeredYear || "1";
  const studentCourse = location.state?.registeredCourse || "B.Tech Computer Science";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFF5EC] via-[#FFE8D6] to-[#FAD4BA] text-[#111111] font-sans p-4 sm:p-6 lg:p-10 relative overflow-hidden flex flex-col items-center">
      ...
      {/* Centralized Unit */}
      <div className="w-full max-w-[650px] relative z-10 flex flex-col gap-6 mt-4 sm:mt-10">
        
        {/* --- Header --- */}
        <header className="bg-white rounded-2xl p-6 shadow-md border border-orange-100 flex justify-between items-center">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-orange-50 rounded-full flex items-center justify-center text-[#EE6132] font-black text-lg shadow-sm">
              S
            </div>
            <div>
              <h1 className="font-extrabold text-xl leading-none mb-1">Student Portal</h1>
          ...
          {!paymentSuccess ? (
            ...
            >
              <div className="bg-gray-50 p-6 border-b border-gray-100 text-center relative">
                ...
                <h2 className="text-sm font-black text-gray-800 uppercase tracking-widest">Semester Fee Clearance</h2>
              </div>
              
              <div className="p-8 sm:p-12 space-y-8 text-center">
                
                {/* Auto-Calculated Semester */}
                <div className="inline-block px-6 py-2 bg-orange-50 border border-orange-100 rounded-full">
